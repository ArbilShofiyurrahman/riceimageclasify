...
if not os.path.exists('riceimageclassify'):
    subprocess.run(["git", "clone", "https://github.com/ArbilShofiyurrahman/riceimageclassify.git"])

# Path dataset
dataset_path = './riceimageclassify'
